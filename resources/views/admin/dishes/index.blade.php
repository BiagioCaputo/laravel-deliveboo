        ...
        <table class="table table-striped ">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="media1000">Immagine</th>
                    <th scope="col">Prezzo</th>
                    <th scope="col" class="media770">Descrizione</th>
                    <th scope="col">Disponibilità</th>
                    <th scope="col" class="media770">Portata</th>
                    <th scope="col">
                        {{-- Cestino --}}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="media1000"><img class="img-table" src="{{ $dish->getImage() }}" alt="{{ $dish->name }}">
                    </td>
                    <td>{{ $dish->getPrice() }}</td>
                    <td class="media770">{{ $dish->description }}</td>
                    ...
                    <td>
                        <div class="gap-2 crud-group">
                            <!--View-->
                            <a href="{{ route('admin.dishes.show', $dish) }}" class="btn btn-primary"><i class="fas fa-eye "></i></a>
                            <!--Edit-->
                            <a href="{{ route('admin.dishes.edit', $dish->id) }}" class="btn btn-warning"><i class="fas fa-pencil "></i></a>
                            <!--Soft Delete-->
